...
Register_Class(FilePacket)

FilePacket::FilePacket() : ::inet::FieldsChunk()
{
}

FilePacket::FilePacket(const FilePacket& other) : ::inet::FieldsChunk(other)
{
    copy(other);
}
...
unsigned int FilePacket::getNframes() const
{
    return this->nframes;
}

void FilePacket::setNframes(unsigned int nframes)
{
    handleChange();
    this->nframes = nframes;
}

unsigned int FilePacket::getIDframe() const
{
    return this->IDframe;
}

void FilePacket::setIDframe(unsigned int IDframe)
{
    handleChange();
    this->IDframe = IDframe;
}

omnetpp::simtime_t FilePacket::getPayloadTimestamp() const
{
    return this->payloadTimestamp;
}

void FilePacket::setPayloadTimestamp(omnetpp::simtime_t payloadTimestamp)
{
    handleChange();
    this->payloadTimestamp = payloadTimestamp;
}

unsigned int FilePacket::getPayloadSize() const
{
    return this->payloadSize;
}

void FilePacket::setPayloadSize(unsigned int payloadSize)
{
    handleChange();
...
class FilePacketDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    FilePacketDescriptor();
    virtual ~FilePacketDescriptor();
...
Register_ClassDescriptor(FilePacketDescriptor)

FilePacketDescriptor::FilePacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(FilePacket)), "inet::FieldsChunk")
{
    propertyNames = nullptr;
}

FilePacketDescriptor::~FilePacketDescriptor()
{
    delete[] propertyNames;
}

bool FilePacketDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<FilePacket *>(obj)!=nullptr;
}

const char **FilePacketDescriptor::getPropertyNames() const
{
    if (!propertyNames) {
...
const char *FilePacketDescriptor::getProperty(const char *propertyName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
...
const char *FilePacketDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char *FilePacketDescriptor::getFieldProperty(int field, const char *propertyName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
int FilePacketDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    FilePacket *pp = omnetpp::fromAnyPtr<FilePacket>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}

void FilePacketDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    FilePacket *pp = omnetpp::fromAnyPtr<FilePacket>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'FilePacket'", field);
    }
}

const char *FilePacketDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string FilePacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void FilePacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'FilePacket'", field);
    }
}

omnetpp::cValue FilePacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'FilePacket' as cValue -- field index out of range?", field);
    }
}

void FilePacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
const char *FilePacketDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
omnetpp::any_ptr FilePacketDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void FilePacketDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
